...
Fetches Dogecoin price, market data, and on-chain metrics from free APIs.
...
def analyze_data(price_data, chain_data):
    ...
    fee = chain_data.get("fee_24h_usd") or 0
    ...
    support = round(price * 0.93, 5)  # rough estimate
...
def main():
    ...
    print(f"  On-chain: {chain_data['transactions_24h']} tx/24h | {chain_data['mempool_transactions']} mempool")

    # Analyze
    analysis = analyze_data(price_data, chain_data)
    ...
    # Also write an index of all reports
